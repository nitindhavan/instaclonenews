            ...
            children: <Widget>[
              ...
              isLastMessageLeft(index)
                ...
                child: Text(
                  ...
                  style: TextStyle(color: Colors.black12, fontSize: 12, fontStyle: FontStyle.italic),
                ),
  ...
  Widget buildSticker() {
    return Expanded(
      child: Container(
        ...
        decoration: BoxDecoration(
            border: Border(top: BorderSide(color:Colors.black12, width: 0.5)), color: Colors.white),
